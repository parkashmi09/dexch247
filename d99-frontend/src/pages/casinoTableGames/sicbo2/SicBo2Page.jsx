  ...
  return (
    ...
    >
      <div className="casino-page-container sicbo">
        ...
        <CasinoHeader name="Sic Bo 2" gameId={GAME_ID} roundId={roundId} />
        ...
        <div className={mobilePanelTab === "bets" ? "d-none d-xl-block" : ""}>
          <CasinoVideoBox src={iframeSrc} gameName="Sic Bo 2" gameType={null}
      ...
      <CasinoResultModal show={resultModal.show} onHide={() => setResultModal({ show: false, mid: "" })}
        gameId={GAME_ID} gameType="sicbo2" mid={resultModal.mid} title="Sic Bo 2 Result" />
    </Layout>
  );
}
