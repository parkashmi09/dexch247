...
const GAME_ID = "joker20";

export default function Joker20Page() {
  const {
    gameData,
    tableData,
    iframeSrc,
  ...
  return (
    ...
    >
      <div className="casino-page-container teenpatti-joker">
        ...
        <CasinoHeader name="Teenpatti Joker 20-20" gameId={GAME_ID} roundId={roundId} />
        ...
        <div className={mobilePanelTab === "bets" ? "d-none d-xl-block" : ""}>
          <CasinoVideoBox
            src={iframeSrc}
            gameName="Teenpatti Joker 20-20"
            gameType="joker20"
