...
import { BetTableTeen1 } from "../../../components/casino/tables/teen1/index.jsx";
import { CASINO_GAME_IDS, formatTeen1Result } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.TEEN1;

export default function Teen1Page() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatTeen1Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container onecard1day position-relative">
        {loading && <CasinoLoader />}

        <CasinoHeader name="1 CARD ONE-DAY" gameId={GAME_ID} roundId={roundId} />
