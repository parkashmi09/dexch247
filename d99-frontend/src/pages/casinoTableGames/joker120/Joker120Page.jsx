...
// Unlimited Joker 20-20 — same structure as joker1 (joker + Player A/B), 20-20
// variant. Reuses the joker1 table + video-card components.
const GAME_ID = "joker120";

function formatJoker120Result(r) {
  return { label: "R", mid: r.mid != null ? String(r.mid) : "", win: r.win || "", type: "result-b" };
}

export default function Joker120Page() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatJoker120Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container teenpatti-joker1">
        ...
        <CasinoHeader name="Unlimited Joker 20-20" gameId={GAME_ID} roundId={roundId} />
          ...
          <div className="casino-video">
            <div className="video-box-container">
              <div className="casino-video-box">
                {iframeSrc && <iframe src={iframeSrc} title="Unlimited Joker 20-20" allowFullScreen allow="autoplay" />}
              </div>
            </div>
      ...
      <CasinoResultModal
        ...
        gameType="joker120"
        mid={resultModal.mid}
        title="Unlimited Joker 20-20 Result"
      />
    </Layout>
  );
}
