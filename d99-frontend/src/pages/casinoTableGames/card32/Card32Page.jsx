...
import BetTableCard32 from "../../../components/casino/tables/card32/BetTableCard32.jsx";
import { CASINO_GAME_IDS, formatCard32Result } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.CARD32;

export default function Card32Page() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatCard32Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container cards32a">
        ...
        <CasinoHeader name="32 Cards A" gameId={GAME_ID} roundId={roundId} />
