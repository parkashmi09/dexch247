...
import BetTableCard32EU from "../../../components/casino/tables/card32eu/BetTableCard32EU.jsx";
...
const GAME_ID = CASINO_GAME_IDS.CARD32EU;
  ...
  return (
    ...
    >
      <div className="casino-page-container cards32b">
        ...
        <CasinoHeader name="32 Cards B" gameId={GAME_ID} roundId={roundId} />
