...
import { BetTableAAA } from "../../../components/casino/tables/aaa/index.jsx";
import {
  CASINO_GAME_IDS,
  formatAAAResult,
...
const GAME_ID = CASINO_GAME_IDS.AAA;
...
export default function AAAPage() {
  const {
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatAAAResult });
  ...
  return (
    ...
    >
      <div className="casino-page-container aaa">
        ...
        <CasinoHeader name="Amar Akbar Anthony" gameId={GAME_ID} roundId={roundId} />
      ...
      <CasinoResultModal
        ...
        gameType="aaa"
        mid={resultModal.mid}
        title="Amar Akbar Anthony Result"
      />
    </Layout>
  );
}
