...
import { BetTableWar } from "../../../components/casino/tables/war/index.jsx";
import {
  CASINO_GAME_IDS,
  formatWarResult,
...
const GAME_ID = CASINO_GAME_IDS.WAR;
...
export default function WarPage() {
  const {
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatWarResult });
  ...
  return (
    ...
    >
      <div className="casino-page-container casino-war">
        {loading && <CasinoLoader />}

        <CasinoHeader name="Casino War" gameId={GAME_ID} roundId={roundId} />
