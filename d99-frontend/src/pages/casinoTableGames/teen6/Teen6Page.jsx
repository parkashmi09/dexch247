...
import { BetTableTeen6 } from "../../../components/casino/tables/teen6/index.jsx";
import { CASINO_GAME_IDS, formatTeen6Result } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.TEEN6;

export default function Teen6Page() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatTeen6Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container teenpatti2 position-relative">
        {loading && <CasinoLoader />}

        <CasinoHeader name="Teenpatti - 2.0" gameId={GAME_ID} roundId={roundId} />
