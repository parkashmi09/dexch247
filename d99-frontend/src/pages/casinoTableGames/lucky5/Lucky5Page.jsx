...
import { BetTableLucky5 } from "../../../components/casino/tables/lucky5/index.jsx";
import { CASINO_GAME_IDS, formatLucky5Result } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.LUCKY5;

export default function Lucky5Page() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatLucky5Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container lucky7a lucky5">
        {loading && <CasinoLoader />}

        <CasinoHeader name="Lucky 6" gameId={GAME_ID} roundId={roundId} />
