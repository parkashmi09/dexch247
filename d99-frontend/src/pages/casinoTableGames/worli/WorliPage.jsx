...
import { BetTableWorli } from "../../../components/casino/tables/worli/index.jsx";
import { CASINO_GAME_IDS, formatWorliResult } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.WORLI;

export default function WorliPage() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatWorliResult });
  ...
  return (
    ...
    >
      <div className="casino-page-container worli">
        {loading && <CasinoLoader />}

        <CasinoHeader name="Worli Matka" gameId={GAME_ID} roundId={roundId} hideRules />
