...
import { BetTableDum10, Dum10VideoCards } from "../../../components/casino/tables/dum10/index.jsx";
import {
  CASINO_GAME_IDS,
  formatDum10Result,
...
const GAME_ID = CASINO_GAME_IDS.DUM10;

export default function Dum10Page() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatDum10Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container duskadum">
        {loading && <CasinoLoader />}

        <CasinoHeader name="Dus Ka Dum" gameId={GAME_ID} roundId={roundId} />
          ...
          <div className="casino-video">
            <div className="video-box-container">
              <div className="casino-video-box">
                {iframeSrc && <iframe src={iframeSrc} title="Dus Ka Dum" allowFullScreen allow="autoplay" />}
              </div>
            </div>
            <Dum10VideoCards cardString={cardString} tableData={gameData} />
              ...
              <div className="casino-last-results">
                {lastResults.map((r, i) => (
                  <span
                    ...
                    onClick={() =>
                      setResultModal({ show: true, mid: r.mid || "" })
                    }
                  >
                    {r.label}
                  </span>
