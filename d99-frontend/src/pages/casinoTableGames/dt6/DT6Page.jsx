...
import BetTableDT6 from "../../../components/casino/tables/dt6/BetTableDT6.jsx";
import { CASINO_GAME_IDS } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.DT6;

function formatDT6Result(r) {
...
export default function DT6Page() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatDT6Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container dt1day">
        {loading && <CasinoLoader />}

        <CasinoHeader name="1 Day Dragon Tiger" gameId={GAME_ID} roundId={roundId} />
