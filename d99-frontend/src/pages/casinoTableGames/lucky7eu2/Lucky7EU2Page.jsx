...
import { BetTableLucky7 } from "../../../components/casino/tables/lucky7/index.jsx";
import { CASINO_GAME_IDS, formatLucky7Result } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.LUCKY7EU2;

export default function Lucky7EU2Page() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatLucky7Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container lucky7a">
        ...
        <CasinoHeader name="Lucky 7 - C" gameId={GAME_ID} roundId={roundId} />
