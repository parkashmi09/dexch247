...
import { BetTableQueen, QueenVideoCards } from "../../../components/casino/tables/queen/index.jsx";
import { CASINO_GAME_IDS, formatQueenResult } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.QUEEN;
...
export default function QueenPage() {
  const {
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatQueenResult });
  ...
  return (
    ...
    >
      <div className="casino-page-container queen">
        ...
        <CasinoHeader name="Queen" gameId={GAME_ID} roundId={roundId} hideRules />
        ...
        <div className={mobilePanelTab === "bets" ? "d-none d-xl-block" : ""}>
          {/* Pass no gameType so CasinoVideoCards returns null; render QueenVideoCards inline */}
          <div className="casino-video">
            <div className="video-box-container">
              <div className="casino-video-box">
                {iframeSrc ? (
                  <iframe src={iframeSrc} title="Queen" allowFullScreen allow="autoplay" />
                ) : (
            ...
            <QueenVideoCards cardString={cardString} />
