...
export default function Teen33Page() {
  const {
  ...
  return (
    <Layout variant="casino-page"
      ...
      <div className="casino-page-container teenpatti1day">
        ...
        <CasinoHeader name="Instant Teenpatti 3.0" gameId={GAME_ID} roundId={roundId} />
        ...
        <div className={mobilePanelTab === "bets" ? "d-none d-xl-block" : ""}>
          <CasinoVideoBox src={iframeSrc} gameName="Instant Teenpatti 3.0" gameType="teen33" cardString={cardString} clock={<FlipClock value={timer} />} />
      ...
      <CasinoResultModal show={resultModal.show} onHide={() => setResultModal({ show: false, mid: "" })} gameId={GAME_ID} gameType="teen62" mid={resultModal.mid} title="Instant Teenpatti 3.0 Result" />
    </Layout>
  );
}
