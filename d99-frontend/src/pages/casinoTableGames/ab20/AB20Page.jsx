...
import BetTableAB20 from "../../../components/casino/tables/ab20/BetTableAB20.jsx";
import AB20VideoCards from "../../../components/casino/tables/ab20/AB20VideoCards.jsx";
import {
...
const GAME_ID = "ab20";
const GAME_NAME = "Andar Bahar";

function formatAB20Result(r) {
  return {
    label: "R",
...
export default function AB20Page() {
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        ...
        setLastResults((d.res || []).slice(0, 10).map(formatAB20Result));
      } catch { /* ignore */ }
    };
    fetch();
  ...
  return (
    ...
    >
      <div className="casino-page-container ab">
        ...
        <div className={mobilePanelTab === "bets" ? "d-none d-xl-block" : ""}>
          <div className="casino-video">
            ...
            <AB20VideoCards cardString={card} />
            <FlipClock value={timer} />
          </div>

          {sub.length > 0 && (
            <div className="casino-detail">
              <BetTableAB20 gameData={gameData} onBetClick={handleBetClick} exposures={exposures} />
