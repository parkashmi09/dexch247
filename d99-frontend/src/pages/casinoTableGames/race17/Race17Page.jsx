...
import {
  BetTableRace17,
  Race17VideoCards,
} from "../../../components/casino/tables/race17/index.jsx";
import {
  CASINO_GAME_IDS,
  formatRace17Result,
...
const GAME_ID = CASINO_GAME_IDS.RACE17;

export default function Race17Page() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatRace17Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container raceto17">
        {loading && <CasinoLoader />}

        <CasinoHeader name="Race to 17" gameId={GAME_ID} roundId={roundId} />
        ...
        <div className={mobilePanelTab === "bets" ? "d-none d-xl-block" : ""}>
          <div className="casino-video">
            ...
            <Race17VideoCards cardString={cardString} />
