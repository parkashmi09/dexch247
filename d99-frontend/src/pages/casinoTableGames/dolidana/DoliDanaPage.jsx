...
import { BetTableDoliDana } from "../../../components/casino/tables/dolidana/index.jsx";
import DoliDanaRulesTable from "../../../components/casino/tables/dolidana/DoliDanaRulesTable.jsx";
import { CASINO_GAME_IDS } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.DOLIDANA;

// dolidana results always show "R"
function formatDoliResult(r) {
  return {
    label: "R",
...
export default function DoliDanaPage() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatDoliResult });
  ...
  return (
    ...
    >
      <div className="casino-page-container doli-dana position-relative">
        {loading && <CasinoLoader />}

        <CasinoHeader name="Doli Dana" gameId={GAME_ID} roundId={roundId} />
        ...
        <div className={mobilePanelTab === "bets" ? "d-none d-xl-block" : ""}>
          ...
          {tableData.length > 0 && <div className="casino-detail">
            ...
            {/* Mobile rules table */}
            <DoliDanaRulesTable className="d-xl-none w-100" />
