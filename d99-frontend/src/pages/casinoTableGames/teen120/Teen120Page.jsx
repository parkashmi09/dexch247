...
import { BetTableTeen120 } from "../../../components/casino/tables/teen120/index.jsx";
import { CASINO_GAME_IDS, formatTeen120Result } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.TEEN120;

export default function Teen120Page() {
  const {
  ...
  } = useCasinoGame(GAME_ID, { formatResult: formatTeen120Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container onecard20 position-relative">
        {loading && <CasinoLoader />}

        <CasinoHeader name="1 CARD 20-20" gameId={GAME_ID} roundId={roundId} />
