...
import BetTablePoker20 from "../../../components/casino/tables/poker20/BetTablePoker20.jsx";
...
const GAME_ID = "poker20";

export default function Poker20Page() {
  const {
  ...
  return (
    <Layout variant="casino-page"
      ...
      <div className="casino-page-container poker20">
        {loading && <CasinoLoader />}
        <CasinoHeader name="20-20 Poker" gameId={GAME_ID} roundId={roundId} />
        ...
        <div className={mobilePanelTab === "bets" ? "d-none d-xl-block" : ""}>
          <CasinoVideoBox src={iframeSrc} gameName="20-20 Poker" gameType="poker20" cardString={cardString} clock={<FlipClock value={timer} />} />
          {tableData.length > 0 && <div className="casino-detail">
            <BetTablePoker20 tableData={tableData} onBetClick={handleBetClick} exposures={exposures} />
      ...
      <CasinoResultModal show={resultModal.show} onHide={() => setResultModal({ show: false, mid: "" })} gameId={GAME_ID} gameType="poker20" mid={resultModal.mid} title="20-20 Poker Result" />
    </Layout>
  );
}
