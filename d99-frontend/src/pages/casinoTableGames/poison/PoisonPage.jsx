...
import { CASINO_GAME_IDS, formatPoisonResult } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.POISON;
  ...
  return (
    ...
    >
      <div className="casino-page-container teenpatti-joker">
        ...
        <CasinoHeader name="Teenpatti Poison One Day" gameId={GAME_ID} roundId={roundId} />
