...
export default function Teen42Page() {
  const {
  ...
  return (
    ...
    >
      <div className="casino-page-container teenpatti2">
        ...
        <CasinoHeader name="Jack Top Open Teenpatti" gameId={GAME_ID} roundId={roundId} />
        ...
        <div className={mobilePanelTab === "bets" ? "d-none d-xl-block" : ""}>
          <CasinoVideoBox src={iframeSrc} gameName="Jack Top Open Teenpatti" gameType="teen42"
      ...
      <CasinoResultModal show={resultModal.show} onHide={() => setResultModal({ show: false, mid: "" })}
        gameId={GAME_ID} gameType="teen42" mid={resultModal.mid} title="Jack Top Open Teenpatti Result" />
    </Layout>
  );
}
