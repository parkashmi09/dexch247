...
import { BetTableCmeter } from "../../../components/casino/tables/cmeter/index.jsx";
import { CASINO_GAME_IDS, formatCmeterResult } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";
import useInactivity from "../../../hooks/useInactivity.js";
import { Modal } from "react-bootstrap";

const GAME_ID = CASINO_GAME_IDS.CMETER;

export default function CmeterPage() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatCmeterResult });
  ...
  return (
    ...
    >
      <div className="casino-page-container cmeter">
        {loading && <CasinoLoader />}

        <CasinoHeader name="Casino Meter" gameId={GAME_ID} roundId={roundId} />
        ...
        <div className={mobilePanelTab === "bets" ? "d-none d-xl-block" : ""}>
          {/* Video section — iframe + FlipClock only, no video cards overlay */}
            ...
            <div className="video-box-container">
              <div className="casino-video-box">
                {iframeSrc && !isDisconnected ? (
                  <iframe src={iframeSrc} title="Casino Meter" allowFullScreen allow="autoplay" />
                ) : (
                  !isDisconnected && (
