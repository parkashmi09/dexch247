...
import { BetTableNotenum } from "../../../components/casino/tables/notenum/index.jsx";
import { CASINO_GAME_IDS, formatNotenumResult } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.NOTENUM;

export default function NotenumPage() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatNotenumResult });
  ...
  return (
    ...
    >
      <div className="casino-page-container note-number position-relative">
        {loading && <CasinoLoader />}

        <CasinoHeader name="Note Number" gameId={GAME_ID} roundId={roundId} />
