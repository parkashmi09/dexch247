...
import { BetTableAAA2 } from "../../../components/casino/tables/aaa2/index.jsx";
import {
  CASINO_GAME_IDS,
  formatAAA2Result,
...
const GAME_ID = CASINO_GAME_IDS.AAA2;

export default function AAA2Page() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatAAA2Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container aaa">
        ...
        <CasinoHeader name="Amar Akbar Anthony 2" gameId={GAME_ID} roundId={roundId} />
      ...
      <CasinoResultModal
        ...
        gameType="aaa2"
        mid={resultModal.mid}
        title="Amar Akbar Anthony 2 Result"
      />
    </Layout>
  );
}
