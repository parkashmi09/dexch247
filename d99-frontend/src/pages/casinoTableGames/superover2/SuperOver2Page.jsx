...
export default function SuperOver2Page() {
  ...
  return (
    ...
    >
      <div className="casino-page-container super-over super-over2">
        {loading && <CasinoLoader />}

        <CasinoHeader name="SuperOver 2" gameId={GAME_TYPE} roundId={gmid} />
        ...
        <div className={mobilePanelTab === "bets" ? "d-none d-xl-block" : ""}>
          {/* Video only - no scorecard, no balls for superover2 */}
          <div className="casino-video">
            <div className="video-box-container">
              <div className="casino-video-box">
                {iframeSrc && <iframe src={iframeSrc} title="SuperOver 2" allowFullScreen allow="autoplay" />}
              </div>
            </div>
