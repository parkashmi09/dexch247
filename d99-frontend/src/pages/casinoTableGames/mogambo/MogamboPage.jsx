...
import { BetTableMogambo } from "../../../components/casino/tables/mogambo/index.jsx";
import { CASINO_GAME_IDS, formatMogamboResult } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.MOGAMBO;

export default function MogamboPage() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatMogamboResult });
  ...
  return (
    ...
    >
      <div className="casino-page-container teenpatti2cards mogambo position-relative">
        {loading && <CasinoLoader />}

        <CasinoHeader name="Mogambo" gameId={GAME_ID} roundId={roundId} />
