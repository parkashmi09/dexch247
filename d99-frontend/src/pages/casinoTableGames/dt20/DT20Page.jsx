...
const GAME_ID = CASINO_GAME_IDS.DT20;

function formatDT20Result(r) {
...
export default function DT20Page() {
  const {
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatDT20Result });
  ...
  return (
    ...
    >
      <div className="casino-page-container dt20">
        ...
        <CasinoHeader name="20-20 Dragon Tiger" gameId={GAME_ID} roundId={roundId} />
