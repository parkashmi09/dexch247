...
import {
  BetTableTeensin,
  TeensinColorPlusRules,
} from "../../../components/casino/tables/teensin/index.jsx";
import { CASINO_GAME_IDS, formatTeensinResult } from "../../../components/casino/tables/tableCasinoUtils.js";
import useCasinoGame from "../../../hooks/useCasinoGame.js";

const GAME_ID = CASINO_GAME_IDS.TEENSIN;

export default function TeensinPage() {
  const {
    gameData,
    tableData,
    iframeSrc,
    ...
    handlePlaceBet,
    closeBetPanel,
  } = useCasinoGame(GAME_ID, { formatResult: formatTeensinResult });
  ...
  return (
    ...
    >
      <div className="casino-page-container baccarat29 position-relative">
        {loading && <CasinoLoader />}

        <CasinoHeader name="29Card Baccarat" gameId={GAME_ID} roundId={roundId} />
          ...
          {tableData.length > 0 && (
            <div className="casino-detail">
              ...
              <div className="casino-last-result-title">
                ...
                <span>
                  <a href={`/casino-results/${GAME_ID}`}>View All</a>
                </span>
              </div>
              ...
              <TeensinColorPlusRules className="mt-2 d-xl-none" />
            </div>
          )}
        </div>
