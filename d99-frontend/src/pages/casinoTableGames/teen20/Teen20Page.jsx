  ...
  return (
    ...
    >
      <div className="casino-page-container teenpatti20">
        ...
        <CasinoHeader name="20-20 Teenpatti" gameId={GAME_ID} roundId={roundId} />
      ...
      <CasinoResultModal show={resultModal.show} onHide={() => setResultModal({ show: false, mid: "" })}
        gameId={GAME_ID} gameType="teen20" mid={resultModal.mid} title="20-20 Teenpatti Result" />
    </Layout>
  );
}
