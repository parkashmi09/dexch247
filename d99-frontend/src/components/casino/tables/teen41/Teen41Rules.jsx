export default function Teen41Rules() {
  return (
    <>
      <div className="rules-section">
        <ul className="pl-4 pr-4 list-style">
          ...
          <li>In Queen top open teenpatti all three cards of player A will be pre-defined for all the games. These three cards will be permanently placed on the table.
          ...
          <li>Queen top open teenpatti is a three-card game. Three cards will be dealt to player B simultaneously (at the same time) which will decide the result of the game Hence that particular game will be over.</li>
