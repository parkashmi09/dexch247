...
const BetTableAAA2 = memo(function BetTableAAA2({ gameData, onBet, exposures = {} }) {
  const raw = gameData?.data?.data || gameData?.data || gameData || {};
  const sub = raw.sub || [];
  const handleBet = onBet || (() => {});

  // Main markets (back + lay)
  ...
  return (
    <div className="casino-table-box">
      {/* Section 1: Amar / Akbar / Anthony with back + lay */}
      <div className="casino-table-box">
