export default function Teen20bRules() {
  return (
    <div>
      <style>{`
      ...
      <div className="rules-section">
        ...
        <div>
          <img src="/assets/img/casino-rules/teen20b.jpg" alt="20-20 Teenpatti B Rules" />
        </div>
      </div>
      ...
      <div><div className="rules-section">
        ...
        <ul className="pl-2 pr-2 list-style">
          ...
          <li>Ranking of trio from high to low.
            <div className="pl-2 pr-2">1,1,1</div><div className="pl-2 pr-2">K,K,K</div><div className="pl-2 pr-2">Q,Q,Q</div><div className="pl-2 pr-2">J,J,J</div><div className="pl-2 pr-2">10,10,10</div><div className="pl-2 pr-2">9,9,9</div><div className="pl-2 pr-2">8,8,8</div><div className="pl-2 pr-2">7,7,7</div><div className="pl-2 pr-2">6,6,6</div><div className="pl-2 pr-2">5,5,5</div><div className="pl-2 pr-2">4,4,4</div><div className="pl-2 pr-2">3,3,3</div><div className="pl-2 pr-2">2,2,2</div>
          </li>
        ...
        <ul className="pl-2 pr-2 list-style">
          ...
          <li>Ranking of face card from High to low :
            <div className="pl-2 pr-2">Spade King</div><div className="pl-2 pr-2">Heart King</div><div className="pl-2 pr-2">Club King</div><div className="pl-2 pr-2">Diamond King</div>
          </li>
        ...
        <ul className="pl-2 pr-2 list-style">
          ...
          <li>Point value of all the cards :
            <div className="pl-2 pr-2">1 = 1</div><div className="pl-2 pr-2">2 = 2</div><div className="pl-2 pr-2">To</div><div className="pl-2 pr-2">9 = 9</div><div className="pl-2 pr-2">10, J ,Q, K has zero (0) point value .</div>
          </li>
        </ul>
        <p><b>Example 1st:</b></p>
        <ul className="pl-2 pr-2 list-style">
          <li>Last digit of total will be considered as baccarat value
            <div className="pl-2 pr-2">2,5,8 =</div><div className="pl-2 pr-2">2+5+8 =15 here last digit of total is 5 , So baccarat value is 5.</div>
          </li>
        </ul>
        <p><b>Example 2nd :</b></p>
        <ul className="pl-2 pr-2 list-style">
        ...
        <ul className="pl-2 pr-2 list-style">
          ...
          <li>Value of Point Cards :
            <div className="pl-2 pr-2">Ace = 1</div><div className="pl-2 pr-2">2 = 2</div><div className="pl-2 pr-2">3 = 3</div><div className="pl-2 pr-2">4 = 4</div><div className="pl-2 pr-2">5 = 5</div><div className="pl-2 pr-2">6 = 6</div><div className="pl-2 pr-2">7 = 7</div><div className="pl-2 pr-2">8 = 8</div><div className="pl-2 pr-2">9 = 9</div><div className="pl-2 pr-2">10 = 0 (Zero )</div>
          </li>
        ...
        <ul className="pl-2 pr-2 list-style">
          ...
          <li>Ranking of suits from High to low :
            <div className="pl-2 pr-2">Spade</div><div className="pl-2 pr-2">Heart</div><div className="pl-2 pr-2">Club</div><div className="pl-2 pr-2">Diamond</div>
          </li>
        </ul>
      </div></div>
