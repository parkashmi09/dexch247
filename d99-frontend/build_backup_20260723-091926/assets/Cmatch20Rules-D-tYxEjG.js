import{j as t}from"./index-BaiuZ3MK.js";function e(){return t.jsxs("div",{children:[t.jsx("style",{children:`
      ...
      `}),t.jsx("div",{className:"rules-section",children:t.jsxs("ul",{className:"pl-2 pr-2 list-style",children:[t.jsx("li",{children:"This is a game of twenty-20 cricket. We will alreadty have score of first batting team, & score of second batting team up to 19.4 overs. At this stage second batting team will be always 12 run short of first batting team(IF THE SCORE IS TIED, SECOND BAT WILL WIN). This 12 run has to be scored by 2 scoring shots or (two steps)."}),t.jsx("li",{children:"1st step is to be select a scoring shot from 2 , 3 , 4 , 5 , 6 ,7 , 8 , 9 , 10. The one who bet will get rate according to the scoring shot he select from 2 to 10, & that will be considered as ball number 19.5."}),t.jsx("li",{children:"2nd step is to open a card from 40 card deck of 1 to 10 of all suites. This will be considered last ball of the match. This twenty-20 game consist of scoring shots of 1 run to 10 runs."}),t.jsx("li",{className:"text-danger",children:t.jsx("b",{children:"IF THE SCORE IS TIED SECOND BAT WILL WIN"})})]})})]})}export{e as default};
